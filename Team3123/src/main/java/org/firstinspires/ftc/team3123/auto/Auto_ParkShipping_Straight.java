...
@Autonomous(name="Freight Frenzy Auto : Park Shipping Straight", group="Auto")
//@Disabled
public class Auto_ParkShipping_Straight extends LinearOpMode {
...
/*        if (GlobalConfig.alliance == GlobalConfig.Alliance.RED){
        ...
        while (opModeIsActive()) {
            if (runtime.seconds() < FORWARD_TIME){
